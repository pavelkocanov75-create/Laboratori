...
namespace ARLaboratory.Core
{
  ...
  public class Outline : MonoBehaviour 
  {
    ...
    private void Awake()
    {
      ...
      _outlineMaskMaterial = Instantiate(UnityEngine.Resources.Load<Material>(@"Materials/Outline/OutlineMask"));
      _outlineFillMaterial = Instantiate(UnityEngine.Resources.Load<Material>(@"Materials/Outline/OutlineFill"));
      ...
      // Disable on Awake if necessary
      enabled = !_disableOnStart;
    }
